...
if %ERRORLEVEL% NEQ 0 ( exit /b )
php -f ../scripts/lst2bin.php _mendemo1.lst ./release/mendemo1.bin bbk 2000
if %ERRORLEVEL% NEQ 0 ( exit /b )
...
if %ERRORLEVEL% NEQ 0 ( exit /b )
php -f ../scripts/lst2bin.php _mendemo2.lst ./release/mendemo2.bin bbk 2000
if %ERRORLEVEL% NEQ 0 ( exit /b )
...
start ..\..\bkemu\BK_x64.exe /C BK-0011M /B .\release\mendemo1.bin
